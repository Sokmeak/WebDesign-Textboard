...
function generateCanvasContent() {
  ...
  // Ensure the canvas is only created once
...
function getSelectedFont() {
  ...
  switch (myFont) {
    ...
    case "Monofett":
      return "'Monofett', monospace";
    case "rubik-broken-fax":
      return "'Rubik Broken Fax',system-ui";
    default:
      return myFont;
  }
}
...
//   switch (frameColorSelected) {
  function getFrameColor() {
    let FrameColor = document.getElementById("frame-color-selector").value;
    switch (FrameColor) {
    case "Gold":
      return "#fac123";
    case "Silvar":
